    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone', models.CharField(blank=True, help_text='Digite apenas números', max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Digite apenas números.', regex='^[0-9]*$')])),
                ...
                ('dados_pagamento1', models.CharField(blank=True, max_length=120, null=True, verbose_name='Informações de pagamentos 1')),
                ('dados_pagamento2', models.CharField(blank=True, help_text='Suas contas PIX, dados bancários, carteiras crypto e etc...', max_length=120, null=True, verbose_name='Informações de pagamentos 2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titulo', models.CharField(help_text='Titulo', max_length=100, verbose_name='')),
